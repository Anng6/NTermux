...
public class TermuxApiReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (mPreferences == null || !mPreferences.isTapiEnabled()){
            Toast.makeText(context, "NTermuxAPI: 已拒绝API授权", Toast.LENGTH_LONG).show();
            ResultReturner.returnData(this, intent, out -> out.append("NTermuxAPI: Permission denied.\n"));
            return;
        }
        try {
